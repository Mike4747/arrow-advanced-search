...
import * as strings from 'ArrowAdvancedSearchWebPartStrings';
import SearchDialog from './components/SearchDialog';
import { IArrowSearchWebPartProps } from './ArrowAdvancedSearchWebPartProps';
import {ISearchDialogProps} from './components/SearchDialogProps';
...
export default class ArrowAdvancedSearchWebPart extends BaseClientSideWebPart<IArrowSearchWebPartProps> {
  ...
  /**
	 ...
	 */
  private _getElement(externalTemplate?: IExternalTemplate): React.ReactElement<ISearchDialogProps> {
    return React.createElement(SearchDialog, {
      title: this.properties.title,
      query: this.properties.query,
      maxResults: this.properties.maxResults,
      sorting: this.properties.sorting,
      refinementFilters: this.properties.refinementFilters,
      context: this.context,
      firstRender: this.renderedOnce,
      template: this.properties.template,
      externalTemplate: externalTemplate,
      parentCallback: this.onChildChanged
    });
  }

  public onChildChanged(message) {
  ...
  private _loadStyles(stylesToLoad: IStyles[]): void {
	 ...
	 */
  public render(): void {
    console.log('ArrowSearchWebPart.render');
        ...
        groups: [{
          ...
          groupFields: [
            ...
            PropertyPaneTextField('refinementFilters', {
              label: strings.FieldsRefinementFilters
            })
